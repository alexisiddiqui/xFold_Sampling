...
def dir_to_xtc_ordered(
    json_path: str, input_dir: str, output_dir: str = None, residue_range: tuple = (None, None)
):
    """
...
if __name__ == "__main__":
    ...
    # json_path = (
    #     "projects/xFold_Sampling3/af_sample/BPTI/BPTI/P00974_60_0_af_sample_127_10000_ranks.json"
    # )

    # input_dir = (
    #     "projects/xFold_Sampling3/af_sample/BPTI/BPTI/P00974_60_0_af_sample_127_10000_protonated"
    # )

    # dir_to_xtc_ordered(json_path, input_dir)

    # json_path = (
    #     "projects/xFold_Sampling3/af_sample/BPTI/BPTI/P00974_60_1_af_sample_127_10000_ranks.json"
    # )

    # input_dir = (
    #     "projects/xFold_Sampling3/af_sample/BPTI/BPTI/P00974_60_1_af_sample_127_10000_protonated"
    # )

    # dir_to_xtc_ordered(json_path, input_dir)

    # json_path = (
    #     "projects/xFold_Sampling3/af_sample/BPTI/BPTI/P00974_60_2_af_sample_127_10000_ranks.json"
    # )

    # input_dir = (
    #     "projects/xFold_Sampling3/af_sample/BPTI/BPTI/P00974_60_2_af_sample_127_10000_protonated"
    # )

    # dir_to_xtc_ordered(json_path, input_dir)

    # json_path = (
    #     "projects/xFold_Sampling3/af_sample/BPTI/BPTI/P00974_60_3_af_sample_127_10000_ranks.json"
    # )

    # input_dir = (
    #     "projects/xFold_Sampling3/af_sample/BPTI/BPTI/P00974_60_3_af_sample_127_10000_protonated"
    # )
    ...
    # json_path = (
    #     "projects/xFold_Sampling3/af_sample/BRD4/BRD4/BRD4_APO_484_1_af_sample_127_10000_ranks.json"
    # )
    # input_dir = (
    #     "projects/xFold_Sampling3/af_sample/BRD4/BRD4/BRD4_APO_484_1_af_sample_127_10000_protonated"
    # )
    # dir_to_xtc_ordered(json_path, input_dir)

    # json_path = (
    #     "projects/xFold_Sampling3/af_sample/HOIP/HOIP/HOIP_apo697_1_af_sample_127_10000_ranks.json"
    # )
    # input_dir = (
    #     "projects/xFold_Sampling3/af_sample/HOIP/HOIP/HOIP_apo697_1_af_sample_127_10000_protonated"
    # )
    # dir_to_xtc_ordered(json_path, input_dir)
    # json_path = (
    #     "projects/xFold_Sampling3/af_sample/LXRa/LXRa/LXRa200_1_af_sample_127_10000_ranks.json"
    # )
    # input_dir = (
    #     "projects/xFold_Sampling3/af_sample/LXRa/LXRa/LXRa200_1_af_sample_127_10000_protonated"
    # )
    # dir_to_xtc_ordered(json_path, input_dir)
    ...
    json_path = "/home/alexi/Documents/xFold_Sampling/af_sample/HOIP_dab3/HOIP_dab3_1_af_sample_21_100_ranks.json"
    input_dir = "/home/alexi/Documents/xFold_Sampling/af_sample/HOIP_dab3/HOIP_dab3_1_af_sample_21_100_protonated"
    dir_to_xtc_ordered(json_path, input_dir)
