...
class BoltzParams:
    ...
    recycling_steps: list[int] = field(default_factory=lambda: [1, 3,10])
    diffusion_samples: list[int] = field(default_factory=lambda: [100]) # warning this puts all samples in VRAM
    step_scale: list[float] = field(default_factory=lambda: [1, 1.638, 2])
    ...
    max_paired_seqs: List[int] = field(default_factory=lambda: [1024])
